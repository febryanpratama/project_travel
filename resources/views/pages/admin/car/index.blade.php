            ...
            <table class="table table-bordered yajra-datatable">
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="text-center">Category Car</th>
                        <th class="text-center">Door Car</th>
                        <th class="text-center">Seat Car</th>
                        <th class="text-center">Baggage Car</th>
                        <th class="text-center">Price Car / Day</th>
