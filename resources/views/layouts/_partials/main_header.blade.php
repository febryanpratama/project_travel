      ...
      <div class="row">
         <div class=" col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
            <div class="hs_logo_wrapper d-none d-sm-none d-xs-none d-md-block">
               <a href="index-2.html">
               <img src="{{ asset('assets') }}/images/logo.png" class="img-responsive" alt="logo" title="Logo" />
               </a>
            </div>
         </div>
         <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
            <div class="hs_navi_cart_wrapper  d-none d-sm-none d-xs-none d-md-block d-lg-block d-xl-block">
               <div class="dropdown-wrapper menu-button menu_button_end">
                   <a class="menu-button" href="#"><i class="flaticon-shopping-cart"></i>
                    @if (Auth::check())
                        <span>{{ count(App\Helpers\Format::cart(Auth::user()->id)) }}</span>
                    @else
                        <span>0</span>
                    @endif
                    </a>
                                ...
                                <a href="{{ url('checkout') }}">
                                    <div class="cc_cart_wrapper1">
                                        ...
                                        <div class="cc_cart_cont_wrapper">
                                            <h4><a href="#">{{ $key->car->name_car }}</a></h4>
                                            <p>Quantity : 2 × $45</p>
                                            <h5>$90</h5>
