    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                @role('Admin')
                <li class="menu-item">
                    <a href="{{ url("admin/category-car") }}" class="menu-link">
                        <div data-i18n="Category Car">Category Car</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url("admin/car") }}" class="menu-link">
                ...
                @role('Tenant')
                <li class="menu-item">
                    <a href="{{ url("tenant/car") }}" class="menu-link">
                        <div data-i18n="Car">Car</div>
                    </a>
                </li>
                @endrole
